...
void Surface::stone_plates(float x, float y, float z, float* color, unsigned char seed) {
    ...
    float cracks0 = Distortion::sig(Noise::voronoi3(x * 16, y * 16, z * 16, 0.99f, 0.5f, 2.0f, seed) * 16.0f - 16.0f);
    ...
    float stones = 0.1 + 1.8f * fmin(0.5f, 3 * Distortion::rampPyramid(0, 0, 1, 1, fmod(x * 8, 1), fmod(y * 8, 1)));
