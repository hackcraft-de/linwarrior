...
struct cLandscape {
    ...
    /**
     * ~[0,1] normalized utah rock landscape.
     */
     ...
     */
    static inline void land_dunes(float x, float y, float z, float* color, unsigned char seed = 131) {
        // Prime periods => large smallest common multiple.
     ...
     */
    static inline void land_lava(float x, float y, float z, float* color, unsigned char seed = 131) {
        float power = 5;
    ...
    static inline void land_grass(float x, float y, float z, float* color, unsigned char seed = 131) {
        const float p1 = 1.0f / 101.0f;
    ...
    static inline void land_snow(float x, float y, float z, float* color, unsigned char seed = 131) {
        const float p1 = 1.0f / 101.0f;
        float o1 = cNoise::simplex3(37 + x*p1, 67 + y*p1, 97 + z*p1, seed + 0);
    ...
    static inline void land_dirt(float x, float y, float z, float* color, unsigned char seed = 131) {
        const float p1 = 1.0f / 101.0f;
        float o1 = cNoise::simplex3(37 + x*p1, 67 + y*p1, 97 + z*p1, seed + 0);
    ...
    static inline void decoration_spikes(float x, float y, float z, float* color, unsigned char seed = 131) {
        const int n = 4;
        float o = 0;
    ...
    static inline void decoration_stones(float x, float y, float z, float* color, unsigned char seed = 131) {
        const int n = 4;
        float o = 0;
        const float p[] = {1.0f / 47.0f, 1.0f / 23.0f, 1.0f / 11.0f, 1.0f / 7.0f};
        const float sx[] = {231, 123, 45, 31, 13, 7, 3};
    ...
    static inline void mashup_lava(float x, float y, float z, float* color, unsigned char seed = 131) {
    ...
    static inline void experimental_continents(float x, float y, float z, float* color, unsigned char seed = 131) {
        const int n = 8;
        float o = 0;
